...
namespace CCMS.DAL.Entities
{
    ...
    public class PatientFamily : Base
    {
        ...
        public PatientFamily(string relationship, string patientId, int familyMemberId, string createdBy)
            : base(createdBy)
            => Set(relationship, patientId, familyMemberId);

        private void Set(string relationship, string patientId, int familyMemberId)
        {
        ...
        public void Edit(string relationship, string patientId, int familyMemberId, string modifiedBy)
        {
            Set(relationship, patientId, familyMemberId);
